INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:08:FC:DD', 'Combot', 'Un proyecto con eje ecológico',
'Un proyecto con eje ecológico. Conocé ComBot,  la compactadora de botellas PET creada en su totalidad por Martín Pérez Mendoza y Santiago Carrillo.', 'https://user-images.githubusercontent.com/7771294/68998284-32920f80-088f-11ea-86aa-648135b7d262.jpg', 5,-34.6403175,-58.4018125, 10);

INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:04:19:2F', 'Auto Formula SAE',
'Creado por estudiantes de Ingeniería Mecánica del ITBA','Auto Fórmula SAE creado por estudiantes de Ingeniería Mecánica del ITBA.', 'https://user-images.githubusercontent.com/7771294/68998234-83553880-088e-11ea-8763-b01236188de6.jpg', 5,-34.6403200,-58.40183001, 20);

INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:04:18:A0', 'SYNTHETIC VOICE HARMONIZATION',
'Software para armonizar sonidos musicales', 'El proyecto se basa en el diseño de un software para armonizar sonidos musicales. Un armonizador es una aplicación de hardware o software que toma una señal de audio y le suma su tercera voz (los sonidos de la señal desplazados en su escala musical). El programa recibe un archivo de audio, calcula la escala de la pieza musical, determina las notas y las desplaza en su escala para obtener la tercera voz. Esta voz es sumada a la original, creando un efecto de armonización. Se utilizan algoritmos de procesamiento de audio, como el McLeud Pitch Method y un phase vocoder, con ciertas modificaciones ideadas para obtener la implementación deseada.', 'https://user-images.githubusercontent.com/7771294/68998580-1b552100-0893-11ea-8384-42a22b6d901a.jpeg', 4,-34.6403220,-58.40184121, 5);

INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:04:19:8E', 'GAZE TRACKER',
'Detección y seguimiento de pupilas', 'Es un sistema de detección y seguimiento de pupilas utilizando una webcam, aplicado a la estimación de la posición de la vista del usuario.', 'https://user-images.githubusercontent.com/7771294/68998629-c239bd00-0893-11ea-9f84-9cf179282c6d.jpeg', 4,-34.6403300,-58.40187172, 5);

INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:04:1B:E4', 'TATEMATIC',
'Tatetí con compuertas lógicas','El proyecto consiste en un juego de Tatetí, implementado únicamente con compuertas lógicas y utilizando una CPLD (Complex Programmable Logic Device). El juego permite jugador vs jugador o jugador vs máquina. Además, maneja una salida de audio que indica el estado de la jugada.', 'https://user-images.githubusercontent.com/7771294/68998767-522c3680-0895-11ea-92ee-695cc8f8be5f.jpg', 3,-34.6403340,-58.4018002, 5);

INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:04:19:21','PROTOTIPO DE PROYECTOR LASER',
'Seguidor láser con webcam', 'Es un seguidor Laser con webcam, con posibilidad de dibujar.', 'https://user-images.githubusercontent.com/7771294/68998806-cbc42480-0895-11ea-9c96-c468c3359a8f.jpeg', 3,-34.6403380,-58.40163441, 5);

INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:04:19:3E', 'CONTROL DE ACCESO',
'Control de acceso electrónico','Implementación de un control de acceso electrónico utilizando una CPLD (Complex Programmable Logic Device).', 'https://user-images.githubusercontent.com/7771294/68998873-adaaf400-0896-11ea-9fb7-420463365810.jpg', 2,-34.6403400,-58.4014111, 5);

INSERT INTO stand(id, title, short_description, description, cover, ranking, latitude, longitude, average_time) VALUES('0C:F3:EE:04:18:AC', 'PEDAL WAH WAH INALÁMBRICO',
'Pedal analógico controlado digitalmente','Los pedales Wah Wah son accesorios para guitarras que se usan desde los años 70. Existen pedales analógicos y digitales. Los primeros son caros y dominan el mercado, mientras que los segundos tienen más prestaciones y si bien son potencialmente escalables para producción en serie, no son aceptados por el mercado. El Wah Wah inalámbrico propuesto es un pedal analógico controlado digitalmente, es decir que reúne las ventajas comerciales de uno y las prestaciones de otro.', 'https://user-images.githubusercontent.com/7771294/68998872-adaaf400-0896-11ea-8ccf-2a7efb2b476e.jpeg', 4,-34.6403299,-58.4015221, 5);
